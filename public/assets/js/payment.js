...
$("#payment-form").unbind("submit").bind("submit", function (event) {
    ...
    if (result.error) {
      ...
      $.ajax({
        ...
        success: function success(response) {
          ...
          $("#loading_button").removeClass("fa fa-spinner fa-spin");
          $("#stripe_payment_button").removeClass("disabled_button");
          document.getElementById("modal_stripe_pay").style.display = "none";
          alert("success! Please check your email.");
        }
      });
    }
...
module.exports = __webpack_require__(/*! D:\Projects\005_diet_project_laravel\diet_plan_v.1.0\resources\js\payment.js */"./resources/js/payment.js");
